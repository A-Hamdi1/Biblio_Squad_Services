...
class _TranslationScreenState extends State<TranslationScreen> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
        ...
        builder: (context, translationProvider, languageProvider, child) {
          ...
          return Stack(
            children: [
              ...
              TranslationOverlay(translations: translationProvider.detectedTexts),
            ],
          );
        },
      ),
          ...
          return FloatingActionButton(
            onPressed: () {
              translationProvider.captureAndTranslate(
                languageProvider.isAutomaticDetection ? 'auto' : languageProvider.sourceLanguage,
